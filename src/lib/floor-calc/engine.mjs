 ...
 *   ≤10 ตร.ม. = เต็มเพดานเรนจ์ (งานเล็ก เหมาแพง · เคสตัวอย่างในไฟล์ 6.3 ตร.ม. ใช้ 800 = เพดาน)
 *   ≥30 ตร.ม. = พื้นเรนจ์
 * ⚠ ใช้เฉพาะรายการที่ไฟล์ให้มาเป็น "ช่วงราคา" (กระเบื้อง/ฝ้า) เท่านั้น
 *   เข็ม/ขุด/ฟุตติ้ง/คาน/เทพื้น/ก่ออิฐ เป็นราคาต่อหน่วยคงที่ ห้ามเอามาไล่ระดับ
 */
...
export const suggest = {
   ...
   */
  sand: (area) => Math.round((5100 + 300 * area) / 100) * 100,
  /**
