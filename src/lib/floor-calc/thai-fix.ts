...
const SURE: Rule[] = [
  ...
  // ไมโครไพล์ (micropile) — สะกดผิดบ่อย (ไมโคไฟย์/ไมโครไฟล์/ไมโคไพล์) · คำที่ถูกอยู่แล้วไม่แตะ
  { from: /ไมโคร?ไฟล?ย?์|ไมโคไพล์|ไมโครไพน์/g, to: "ไมโครไพล์", why: "ไมโครไพล์ (micropile)" },
