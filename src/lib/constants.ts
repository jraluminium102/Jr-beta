...
// ช่องทางชำระเงิน (ใบวางบิล) — default ท้ายใบ (ซ้ายล่าง) · แก้ต่อใบได้บน PDF (payment_note · 0104)
// เก็บที่เดียว — แก้เลขบัญชี/ชื่อบัญชีที่นี่ที่เดียว มีผลทุกใบที่ยังไม่ได้แก้เอง
export const DEFAULT_PAYMENT_NOTE = [
  "ชำระโดย",
  "โอนเข้าบัญชี  ธนาคารกรุงศรีอยุธยา",
  "เลขบัญชี  248-143062-0",
  "ชื่อบัญชี  บริษัท เจอาร์อลูมิเนียมแอนด์ กลาส จำกัด",
].join("\n");
