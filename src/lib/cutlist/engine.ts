...
export type CutInput = {
  ...
  winHandleColor?: string; // มือจับหน้าต่าง KINGBO-FH3016: "อบขาว" | "ดำ" (คนละรหัสกัน ราคาเท่ากัน)
  winHandleSide?: string;  // มือจับหน้าต่าง: "ซ้าย" | "ขวา" (คนละรหัสกัน)
  ...
  motherHandle?: string;// มือจับใบแม่ — ตัวเลือกจริงดูที่ opts ของแต่ละรุ่น (ต่างกัน: FUJI ใช้ "Cmech กุญแจ+ล็อค/ล็อค+ดัมมี่/ดัมมี่+ดัมมี่" · บานโซลิด ใช้ "Cmech ล็อค+กุญแจ/ดัมมี่+ดัมมี่" + Digital lock/ไม่ใส่)
  childHandle?: string; // มือจับใบลูก — ตัวเลือกจริงดูที่ opts ของแต่ละรุ่น
