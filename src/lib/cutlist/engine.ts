...
export type CutInput = {
  ...
  motherHandle?: string;// มือจับใบแม่: "คิงโบ ล็อค+กุญแจ" | "คิงโบ ดัมมี่+ดัมมี่" | "Cmech"
  childHandle?: string; // มือจับใบลูก: "ไม่ใส่" | "คิงโบ ล็อค+กุญแจ" | "คิงโบ ดัมมี่+ดัมมี่" | "Cmech"
};
