...
const ROOF_SHEET: Record<string, { max: number; w: number }> = {
  ...
  "ชินโคร์ Nature 6มม": { max: 138, w: 138 }, "ชินโคร์ Shade 4มม": { max: 138, w: 138 },
  "ชินโคร์ Prime 10มม": { max: 138, w: 138 }, "ชินโคร์ Grand 10มม": { max: 138, w: 138 },
  'เมทัล 1" PVC': { max: 100, w: 100 }, 'เมทัล 2" PVC': { max: 100, w: 100 },
  'เมทัล 1" เหล็ก-EPS': { max: 100, w: 100 }, 'เมทัล 2" เหล็ก-EPS': { max: 100, w: 100 },
  'เมทัล 1" ฟอยล์-PU': { max: 100, w: 100 }, 'เมทัล 2" ฟอยล์-PU': { max: 100, w: 100 },
  'เมทัล 1" เหล็ก-PU': { max: 100, w: 100 }, 'เมทัล 2" เหล็ก-PU': { max: 100, w: 100 },
};
const SHEET_TYPES = [
