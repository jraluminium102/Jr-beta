...
export const FUJI_SLIDE: CutSpec = {
  ...
  profiles: [
    ...
    // รอยต่อรวม = hook ท่อน · สูงเกิน 2.6 ม. แบ่งครึ่งเป็นเสารับแรง (เจ้าของยืนยัน "ใช้ผสมกัน" 20 ส.ค.69)
    { name: "ตบเกี่ยว", code: "F7983", len: fPost, qty: (o) => (o.H > 260 ? frc(o).hook / 2 : frc(o).hook) },
    ...
    { name: "เสารับแรง", code: "F7951", len: fPost, qty: (o) => (o.H > 260 ? frc(o).hook / 2 : 0), note: "สูงเกิน 2.6 ม. เท่านั้น · แบ่งครึ่งกับตบเกี่ยว · ยาวเท่ากัน" },
...
export const FUJI_SLIDE_CENTER: CutSpec = {
  ...
  profiles: [
    ...
    { name: "ตบเกี่ยว", code: "F7983", len: fcPost, qty: (o) => (o.H > 260 ? fc(o).hook / 2 : fc(o).hook) },
    { name: "เสารับแรง", code: "F7951", len: fcPost, qty: (o) => (o.H > 260 ? fc(o).hook / 2 : 0), note: "สูงเกิน 2.6 ม. เท่านั้น · แบ่งครึ่งกับตบเกี่ยว" },
