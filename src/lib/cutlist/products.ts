...
export const SMS240_BIFOLD: CutSpec = {
  ...
  hardware: [
    ...
    // ⚠ ชุดสลักล็อค = 05-014 ในไฟล์ตัดประกอบ แต่ "ยังไม่มีในสโตร์" (สโตร์มีแค่ 05-004…05-011)
    //   เดิมผูกไว้ที่ JR00563 ซึ่งคือ "CDQ ชุดบานเฟี้ยม CMECH" — คนละตัวกันเลย → เฟี้ยม SMS ทุกใบไปหัก CDQ ผิดตัว
    //   (เจ้าของให้เข้าไปเช็คสโตร์จริง 24 ส.ค.69 · เสิร์ช "สลัก" ในสโตร์ = ไม่เจอสักรายการ)
    //   ปลด sku ออกก่อน → โชว์ในใบตัดให้ช่างเบิกมือ แต่ไม่หักสต็อกผิดตัว · รอเจ้าของเปิดรายการ 05-014 ทั้ง 2 สี
    { name: "ชุดสลักล็อค (Twin Bolt · 05-014)", qty: (o) => sms240Lut(o)?.[8] ?? 0, unit: "ชุด", noStock: true,
      note: "ยังไม่มีในสโตร์ — เบิกมือ" },
    { name: "ซิลิโคน ใน+นอก", sku: "JR00504", qty: (o) => Math.ceil(((2 * (o.W + o.H)) / 100) * 2 / 12.5), unit: "หลอด" },
...
export const PC_DOOR: CutSpec = {
  ...
  profiles: [
    ...
    { name: "กรอบบานเลื่อน sms (กว้าง)", code: "-", len: (o) => o.W / pcN(o) - (o.split === "แบ่ง 4" ? 10 : 10.2), qty: pcN },
    ...
    // คิ้วกระจกวิ่งตามท่อนกรอบ (ไฟล์ไม่มีขนาดคิ้ว — ตัดยาวเท่ากรอบท่อนนั้น แล้วช่างเล็มหน้างาน)
    { name: "คิ้วกระจก (เปิด สูง)", code: "F7935", len: (o) => o.H - pcBeamCut(o) - (pcNoSill(o) ? 3 : 6.3), qty: pcN },
    { name: "คิ้วกระจก (เปิด กว้าง)", code: "F7935", len: (o) => o.W / pcN(o) + (o.split === "แบ่ง 4" ? 0.5 : -1.9), qty: pcN },
    { name: "คิ้วกระจก (เลื่อน สูง)", code: "F7935", len: (o) => o.H - pcBeamCut(o) - (pcNoSill(o) ? 5.8 : 10.3), qty: pcN },
    { name: "คิ้วกระจก (เลื่อน กว้าง)", code: "F7935", len: (o) => o.W / pcN(o) - (o.split === "แบ่ง 4" ? 10 : 10.2), qty: pcN },
  ],
