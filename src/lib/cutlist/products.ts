...
export const EURO_BIFOLD: CutSpec = {
  ...
  hardware: [
    ...
    { name: "HD-481A มัลติพ้อยท์", sku: byColor("hwColor", "JR02946", "JR02945"), qty: ebOdd, unit: "ชุด" },
    { name: "HD-1115 มัลติพ้อยท์", sku: "JR02947", qty: ebOdd, unit: "ชุด" },
    { name: "HD-850 มัลติพ้อยท์", sku: "JR02948", qty: ebOdd, unit: "ชุด" },
    { name: "HD-803 มัลติพ้อยท์", sku: "JR02949", qty: ebOdd, unit: "ชุด" },
    { name: "HD-305 มัลติพ้อยท์", sku: "JR02950", qty: ebHd305, unit: "ชุด", note: "คี่+คี่ / คู่+คี่ = 2 · อื่น 0" },
    { name: "จุดรับล็อค มัลติพ้อยท์", sku: "JR02951", qty: (o) => ebOdd(o) * (o.H <= 270 ? 3 : 4), unit: "จุด" },
    { name: "หมุดล็อค มัลติพ้อยท์", sku: "JR02952", qty: (o) => ebOdd(o) * (o.H <= 270 ? 3 : 4), unit: "ตัว" },
