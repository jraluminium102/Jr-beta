  ...
  //   (3 ราง จะไม่มีเส้นมุ้ง แต่ขึ้นแถวเตือนบนใบตัดให้ช่างเห็น — ห้ามหายเงียบ)
    ...
    case "roof_gable": {
      ...
      m = { spec_id: "gable_straight", input: {
        ...
        sheet, purlin: sp.batten === "แปคู่" ? "แปคู่" : "แปเดี่ยว",
        // 18 ก.ย.69 ตัวเลือกใหม่ตามไฟล์: รางน้ำอลู (หรือ "รางน้ำ" ใบเก่า) = มีราง · ที่เหลือ = ไม่มีรางอลูในใบตัด
        roofEnd: sp.roofend === "รางน้ำอลู" || sp.roofend === "รางน้ำ" ? "รางน้ำ" : "ปล่อยปลาย",
      } };
      break;
    }
