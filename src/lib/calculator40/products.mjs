...
export const PRODUCTS = {
  ...
  open_door: {
    ...
    alu: [
      ...
      // F7864 = 11.328 กก./เส้น 6.4 ม. (เจ้าของแจ้ง 21 ส.ค.69) · F7943 (8 ซม.) ยังไม่มีน้ำหนักจริง ใช้ค่าเดียวกันไปก่อน
      { name: 'เสา (กรอบบาน)', code: "F8?'F7943':'F7864'", price: 1995, kg: 11.328, seg: 'POST', count: '2*P' },
      { name: 'ขวาง (กรอบบาน)', code: "F8?'F7943':'F7864'", price: 1995, kg: 11.328, seg: 'CROSS', count: '2*P' },
