...
export const PRODUCTS = {
  ...
  folding: {
    ...
    alu: [
      ...
      { name: 'B24007 เสา', code: 'B24007', price: 1210, kg: 6.72222, seg: 'H-0.092', count: '2*P' },
      ...
      { name: 'B24009 บังใบ (บานสวิง)', code: 'B24009', price: 325, kg: 1.80556, seg: 'H-0.092', count: "(form.indexOf('เปิดกลาง')>=0 && P%2===1) ? 1 : 0" },
    ],
    glass: 'W*H',
    hardware: [
