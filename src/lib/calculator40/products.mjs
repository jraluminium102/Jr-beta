...
export const PRODUCTS = {
  ...
  open_door: {
    ...
    alu: [
      ...
      { name: 'เฟรมล่าง (ธรณี) F7938', code: 'F7938', price: 1400, kg: 7.77778, seg: 'TOPW', count: 'WIN?0:S' },
      ...
      { name: 'ชนกลาง F7945', code: 'F7945', price: 775, kg: 4.30556, seg: 'S ? H-0.054 : POST-0.0085', count: 'Math.max(P-1,0)' },
      ...
      { name: 'เฟรมล่างช่องแสง F7938', code: 'F7938', price: 1400, kg: 7.77778, seg: 'SW-0.025', count: 'SN' },
