...
export const PRODUCTS = {
  ...
  open_door: {
    ...
    vars: {
      ...
      // ขวาง: บานเดี่ยวหัก 18.5+18.5 · บานคู่ขึ้นไปหัก 18.5+1 (เสากลางใช้ร่วม) — ตามชีต ประตูคู่ ขวาง W1/W2
      CROSS: 'W/P - (P>1 ? 0.0195 : 0.037)',
      // เสา: มีธรณี หัก 18.5+18.5 · ไม่มีธรณี หัก 18.5+7 (ชีต ประตูเดี่ยว/คู่ ไม่มีธรณี)
      POST: 'H - (S ? 0.037 : 0.0255)',
    ...
    alu: [
      ...
      { name: 'เฟรมข้าง F7859', code: 'F7859', price: 1100, kg: 6.11111, seg: 'H', count: '2' },
      { name: 'เฟรมบน F7859', code: 'F7859', price: 1100, kg: 6.11111, seg: 'W-0.05', count: '1' },
      // เฟรมล่าง: ประตูมีธรณี F7938 · หน้าต่าง F7939 (ชีต "บานเปิด") · ประตูไม่มีธรณี ใช้ชายล่าง F7863 แทน
      { name: 'เฟรมล่าง (ธรณี) F7938', code: 'F7938', price: 1400, kg: 7.77778, seg: 'W-0.05', count: 'WIN?0:S' },
      // F7939 ราคาสำรอง = อบขาวในสโตร์ · น้ำหนักยังไม่มีในตาราง ใช้เท่า F7938 ไปก่อน
      { name: 'เฟรมล่าง หน้าต่าง F7939', code: 'F7939', price: 1350, kg: 7.77778, seg: 'W-0.05', count: 'WIN?1:0' },
      { name: 'ตบธรณี F7960', code: 'F7960', price: 575, kg: 3.19444, seg: 'W-0.05', count: 'WIN?0:S' },
