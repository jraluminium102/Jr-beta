...
export const PRODUCTS = {
  ...
  awning: {
    ...
    hardware: [
      ...
      { name: 'แกนล็อค', needCode: true, price: 63, unit: 'ตัว', count: '2*P' },
      { name: 'แป้นรับล็อค', needCode: true, price: 45, unit: 'ตัว', count: '2*P' },
      ...
      { name: 'คลิปเข้ามุม', needCode: true, price: 5, unit: 'ตัว', count: '12*P' },
      { name: 'น็อตเฟรม 1"', sku: 'JR00864', price: 1, unit: 'ตัว', count: '8' },
      { name: 'วาวล์ระบายน้ำ', needCode: true, price: 14, unit: 'ตัว', count: '2' },
    ],
    consum: [
      { name: 'ยางอัดกระจก', sku: 'JR00770', price: 11, unit: 'ม.', count: 'Math.round(2*(W+H)*10)/10' },
      { name: 'ยาง foam', needCode: true, price: 5, unit: 'ม.', count: 'Math.round(4*(W+H)*10)/10' },
      SILICONE,
    ],
  },
