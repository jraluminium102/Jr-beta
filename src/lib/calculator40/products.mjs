...
export const PRODUCTS = {
  ...
  euro_slide: {
    ...
    alu: [
      ...
      { name: 'เฟรมข้าง', code: 'F7978', price: 935, kg: 5.05405, seg: 'H', count: '2' },
      ...
      { name: 'ตบเกี่ยว', code: 'F7983', price: 465, kg: 2.51351, seg: 6.4, count: 'F6' },
      ...
      { name: 'เสารับแรง (สูงเกิน 2.6 ม.)', code: 'F7951', price: 2020, kg: 10.91892, seg: 6.4, count: 'H>2.6?F6:0' },
      ...
      { name: 'ตบยูข้าง (F7988)', code: 'F7988', price: 120, kg: 0.66667, seg: 'H', count: '2' },
      { name: 'ปิดตบเกี่ยว (F7988)', code: 'F7988', price: 120, kg: 0.66667, seg: 'H', count: "LOWRAIL?4:(form==='เปิดคู่กลาง'?2*(P-2):2*(P-1))" },
      { name: 'ตบกันสาด#2 (F7988)', code: 'F7988', price: 120, kg: 0.66667, seg: 'W', count: 'LOWRAIL?0:1' },
      { name: 'ปิดรับล็อค (F7988)', code: 'F7988', price: 120, kg: 0.66667, seg: 'H', count: "form==='เปิดคู่กลาง'?1:0" },
      { name: 'ตบปิดราง F7993', code: 'F7993', price: 120, kg: 0.66667, seg: 'W', count: 'F2' },
      { name: 'ตบราง F7994', code: 'F7994', price: 150, kg: 0.83333, seg: 'W', count: 'F2' },
      // ตบกันสาด — งานใน (รางเตี้ย) ไม่ใช้ (เจ้าของเคาะ 20 ส.ค.69) · ใบตัดก็ตัดออกเหมือนกัน
      { name: 'ตบปิดร่องบน (ตบกันสาด)', code: 'F7992', price: 505, kg: 2.72973, seg: 6.4, count: 'LOWRAIL?0:1' },
      ...
      { name: 'ต่อชนกลาง (ไม่เกิน 2.8 ม.)', code: 'F7925', price: 395, kg: 2.194, seg: 6.4, count: "form==='เปิดคู่กลาง'&&H<=2.8?1:0" },
      { name: 'ชนกลางรับแรง (เกิน 2.8 ม.)', code: 'F7855', price: 1230, kg: 6.64865, seg: 6.4, count: "form==='เปิดคู่กลาง'&&H>2.8?1:0" },
      { name: 'ตบปิดเฟรมร่องใน', code: 'F7880', price: 345, kg: 1.86486, seg: 6.4, count: "form==='เปิดคู่กลาง'?2:0" },
  ...
  slimlux: {
    ...
    alu: [
      { name: 'ขวางบน/ล่าง (WM-K04)', code: 'WM-K04', price: 733, kg: 4.7, seg: 5, count: 'T.h' },
      { name: 'เสาบาน (WM-K01)', code: 'WM-K01', price: 500, kg: 2.95, seg: 5, count: 'T.i' },
      { name: 'ตบเรียบ (WM-K02)', code: 'WM-K02', price: 343, kg: 1.57, seg: 5, count: 'T.j' },
      { name: 'ตบเกี่ยว (WM-K03)', code: 'WM-K03', price: 343, kg: 1.69, seg: 5, count: 'T.k' },
      { name: 'ฝาล่างเล็ก (WM-K20)', code: 'WM-K20', price: 197, kg: 0.5, seg: 5, count: 'T.m' },
      { name: 'ฝาล่างใหญ่ (WM-K21A)', code: 'WM-K21A', price: 233, kg: 0.8, seg: 5, count: 'T.n' },
  ...
  folding: {
    ...
    alu: [
      ...
      { name: 'B24007 เสาบาน', code: 'B24007', price: 1210, kg: 6.72222, seg: '2*(H*P+W)', count: '1' },
      { name: 'B24008 คิ้วตบกระจก', code: 'B24008', price: 265, kg: 1.47222, seg: '2*(H*P+W)', count: '1' },
      { name: 'B24009 ต่อกลาง', code: 'B24009', price: 325, kg: 1.80556, seg: 'H', count: 'P%2===0?1:0' },
    ],
    glass: 'W*H',
    hardware: [
  ...
  fixed: {
    ...
    alu: [
      { box: 'กล่อง|1.6X3', name: 'กล่อง 1.6"x3" (วิ่งรอบ)', price: 1240, kg: 0, seg: 'W', count: '2' },
      { box: 'กล่อง|1.6X3', name: 'กล่อง 1.6"x3" (เสา)', price: 1240, kg: 0, seg: 'H', count: 'P+1' },
      { name: '9014 ตบหน้ากระจก (บน-ล่าง)', code: '9014', price: 380, kg: 0, seg: 'W/P', count: '2*P' },
      { name: '9014 ตบหน้ากระจก (ข้าง)', code: '9014', price: 380, kg: 0, seg: 'H', count: '2*P' },
    ],
    glass: 'W*H',
    hardware: [
  ...
  velora: {
    ...
    alu: [
      ...
      { name: 'วงกบ 3 ด้าน (บน+ซ้าย+ขวา)', code: 'JR02885', price: 768, kg: 3.576, seg: 'W+2*H', count: '1' },
      { name: 'บาน (วิ่งรอบ 4 ด้าน)', code: 'JR02886', price: 720, kg: 2.886, seg: 6.0, count: 'NBAN' },
    ],
    glass: 'W*H',
    hardware: [
  ...
  gate: {
    ...
    vars: {
      ...
      PITCH: '((+spec.rnFace || 4.06) + Math.max(1, +spec.rnGap || 5))',   // ระยะ@ = ด้านโชว์(ซม.)+ช่องห่าง · def 4.06+5=9.06 (คงทุนเดิม) · ห่างมาก=ใบน้อยลง
      E8: "Math.ceil( (Math.trunc((form==='ตั้ง'?(W*100):(H*100))/PITCH)+1) / Math.max(Math.trunc(600/(form==='ตั้ง'?(H*100):(W*100))),1) )",
    ...
    specOpts: [
      // ด้านโชว์ + ระยะ@ ระแนง (ตรงชีต "คิดทุน ประตูรั้ว") — pitch=ด้านโชว์+ช่องห่าง · def 4.06+5=9.06 (คงทุนเดิม) · กล่องเลือกที่ "ลายระแนง (กล่อง)" ด้านบน
      { key: 'rnFace', label: 'ด้านโชว์ระแนง (หน้ากว้างที่หันออก)', def: '4.06',
        opts: ['1', '5', '2.54', '3.81', '4.06', '10.16'],
        labels: { '1': '1 ซม.', '5': '5 ซม.', '2.54': '1″ (2.54)', '3.81': '1.5″ (3.81)', '4.06': '1.6″ (4.06)', '10.16': '4″ (10.16)' }, priced: true },
      { key: 'rnGap', label: 'ระยะ@ ช่องห่างระแนง (ซม.)', type: 'number', def: '5', step: 0.5, placeholder: '5' },   // ห่างมาก = ใช้ใบน้อยลง = ถูกลง
