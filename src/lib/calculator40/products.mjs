...
export const PRODUCTS = {
  ...
  banyok: {
    ...
    alu: [
      { name: 'กล่องร่องมีสกรู', sku: 'JR03022', price: 995, kg: 5.52778, seg: 6.4, count: 'NW' },
      // รหัสเส้นจากไฟล์ตัดประกอบ JR_บานยก_ฟูจิ ชีต "HUNG dies" (ยังไม่มีในสโตร์ → ใช้ราคาสูตรไปก่อน)
      { code: 'B28009', name: 'เฟรมบน', price: 1000, kg: 5.55556, seg: 6.4, count: 'NW' },
      { name: 'อแดปเตอร์บน', sku: 'JR03023', price: 395, kg: 2.19444, seg: 6.4, count: 'NW' },
      { code: 'B28014', name: 'เฟรมล่าง', price: 840, kg: 4.66667, seg: 6.4, count: 'NW' },
      { code: 'B28011', name: 'กรอบบาน', price: 600, kg: 3.33333, seg: 6.4, count: 'NH' },
      { name: 'รางข้าง', sku: 'JR03020', price: 1175, kg: 6.52778, seg: 6.4, count: 'NH' },
    ],
    glass: 'W*H',
    hardware: [
      // เสาเกี่ยว/คิ้วยึด = อลูมิเนียม (เจ้าของยืนยัน 28 ส.ค.69) — รหัสจากไฟล์ตัดประกอบ JR_บานยก_ฟูจิ ชีต "HUNG dies"
      //   ข้อ 5 คิ้วยึดเสาเกี่ยว (ADAPTOR) = B28012 · ข้อ 6 เสาเกี่ยว (INTERLOCK) = B28013
      //   ⚠ 2 รหัสนี้ยังไม่มีในสโตร์ → ใช้ราคาในสูตรไปก่อน สร้างในสโตร์เมื่อไรราคาเด้งเอง
      { name: 'อแดปเตอร์รูสกรู', sku: 'B28012', price: 60, unit: 'เส้น', count: 'NW' },
      { name: 'เสาเกี่ยว', sku: 'B28013', price: 195, unit: 'เส้น', count: 'NH' },
