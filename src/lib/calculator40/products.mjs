...
const SCREEN_FABRIC_ROWS = [   // ผ้ามุ้ง 5 ชนิด (screen/screen_big ใช้ร่วม · ราคาตรงชีต)
  { name: 'ผ้ามุ้ง ไฟเบอร์', sku: 'JR03068', price: 23, unit: 'ตร.ม.', count: "material==='ไฟเบอร์'?FABQ:0" },
  { name: 'ผ้ามุ้ง ไนล่อน', sku: 'JR03077', price: 38, unit: 'ตร.ม.', count: "material==='ไนล่อน'?FABQ:0" },
  { name: 'ผ้ามุ้ง สแตนเลส', sku: 'JR03078', price: 352, unit: 'ตร.ม.', count: "material==='สแตนเลส'?FABQ:0" },
  { name: 'ผ้ามุ้ง กันแมว', sku: 'JR03075', price: 82, unit: 'ตร.ม.', count: "material==='กันแมว'?FABQ:0" },
  { name: 'ผ้ามุ้ง กันหนู (สแตนเลส)', sku: 'JR03072', price: 352, unit: 'ตร.ม.', count: "material==='กันหนู'?FABQ:0" },
];
...
export const PRODUCTS = {
  ...
  awning: {
    ...
    hardware: [
      ...
      { name: 'แกนล็อค', sku: 'JR03002', price: 63, unit: 'ตัว', count: '2*P' },
      { name: 'แป้นรับล็อค', sku: 'JR03003', price: 45, unit: 'ตัว', count: '2*P' },
      ...
      { name: 'คลิปเข้ามุม', sku: 'JR03005', price: 5, unit: 'ตัว', count: '12*P' },
      { name: 'น็อตเฟรม 1"', sku: 'JR00864', price: 1, unit: 'ตัว', count: '8' },
      { name: 'วาวล์ระบายน้ำ', sku: 'JR03004', price: 14, unit: 'ตัว', count: '2' },
    ],
    consum: [
      { name: 'ยางอัดกระจก', sku: 'JR00770', price: 11, unit: 'ม.', count: 'Math.round(2*(W+H)*10)/10' },
      { name: 'ยาง foam', sku: 'JR03006', price: 5, unit: 'ม.', count: 'Math.round(4*(W+H)*10)/10' },
      SILICONE,
    ],
  },
  ...
  folding: {
    ...
    hardware: [
      ...
      { name: 'อุปกรณ์เฟี้ยม (ชุด)', sku: 'JR03007', price: 1, unit: 'ชุด', count: 'HW' },
    ],
    consum: [
      SILICONE,
    ],
  ...
  topslide: {
    ...
    glass: 'W*H',
    hardware: [
      { name: 'รางบน Hafele', sku: 'JR03017', price: 2010, unit: 'เส้น', count: 'Math.ceil(W*2/6)*P' },
      { name: 'ล้อรางบน Hafele 100kg', sku: 'JR00544', price: 1170, unit: 'กล่อง', count: 'P' },   // รหัสตามใบตัด toprail_frame
      { name: 'เสารับ 1"x4"', sku: 'JR03015', price: 905, unit: 'เส้น', count: 'Math.ceil(H/6)' },
      { name: 'คานรับราง 1.6"x4"', sku: 'JR03014', price: 1220, unit: 'เส้น', count: 'Math.ceil(W*2/6)' },
      { name: 'กรอบบาน เสากุญแจ 20051', sku: 'JR00256', price: 885, unit: 'เส้น', count: 'Math.ceil(2*(W+P*H)/6)' },
      { name: 'ชนกลางรับบาน', sku: 'JR03019', price: 300, unit: 'ท่อน', count: 'Math.ceil(H/6)' },
  ...
  eseries: {
    ...
    glass: '((W)+(P-1)*0.1)*H',
    hardware: [
      { name: 'ล้อ ehr-80 (2/บานเลื่อน)', sku: 'JR03018', price: 135, unit: 'ลูก', count: '2*F2' },
  ...
  pcdoor: {
    ...
    alu: [
      ...
      { name: 'กรอบบานเลื่อน sms (สูง)', sku: 'JR03024', price: 1995, kg: 11.328, seg: 'H-0.025-(SILL?0.103:0.058)', count: 'P' },
      { name: 'กรอบบานเลื่อน sms (กว้าง)', sku: 'JR03025', price: 1995, kg: 11.328, seg: "W/P-(form==='แบ่ง 4'?0.10:0.102)", count: 'P' },
  ...
  banyok: {
    ...
    glass: 'W*H',
    hardware: [
      { name: 'กล่องอุปกรณ์', sku: 'JR03021', price: 1350, unit: 'ชุด', count: "form==='ถ่วง'?0:1" },
      { name: 'กล่องอุปกรณ์ (ถ่วง)', sku: 'JR03030', price: 2520, unit: 'ชุด', count: "form==='ถ่วง'?1:0" },
      { name: 'มือจับ', sku: 'JR03027', price: 60, unit: 'ตัว', count: '1' },
      { name: 'ล๊อคกลาง', sku: 'JR03028', price: 70, unit: 'ตัว', count: '1' },
      { name: 'คอยสปริง', sku: 'JR03026', price: 160, unit: 'ตัว', count: '2*DW' },
      { name: 'ฝาปิดฝุ่น', sku: 'JR03029', price: 10, unit: 'ตัว', count: '2*DW' },
      { name: 'ตลับตะขอเกี่ยว', sku: 'JR03031', price: 130, unit: 'ตัว', count: '4*DW' },
      { name: 'กิ๊ปล็อค', sku: 'JR03037', price: 20, unit: 'ตัว', count: '4*DW' },
      { name: 'กล่องใส่สปริง', sku: 'JR03033', price: 30, unit: 'ตัว', count: '2*DW' },
    ],
    consum: [
      SILICONE,
    ],
  ...
  fold_euro: {
    ...
    consum: [
      ...
      { name: 'สักหลาด 5mm', sku: 'JR03032', price: 1.22, unit: 'ม.', count: 'Math.round(((H*1000-94)*2+(H*1000-80)*2)/1000*10)/10' },
  ...
  banklet: {
    ...
    glass: null,
    hardware: [
      { name: 'เฟรม 1"×4" (รอบ+เสาแบ่ง)', sku: 'JR03035', price: 905, unit: 'เส้น', count: 'frameLines' },
      { name: 'ขาเกล็ดโยก', sku: 'JR03036', price: 1, unit: 'ชุด', count: 'P * N * legRate' },
      { name: 'ใบเกล็ด', sku: 'JR03034', price: 572, unit: 'เส้น', count: 'Math.ceil(totalBlades*bladeLen/600)' },
      { name: 'ยู4หุน เกล็ดติดตาย', sku: 'JR03040', price: 1, unit: 'ชุด', count: '(tie>0?2*P:0) * (tie>0?(G/600)*150:0)' },
    ],
    consum: [],
  ...
  curve_fixed: {
    ...
    consum: [
      ...
      { name: 'กล่องเปิด+ตบปิดเปิด', sku: 'JR03039', price: 1849, unit: 'เส้น', count: 'Math.ceil((W*100)/600)' },
  ...
  louver_rotate: {
    ...
    consum: [
      ...
      { orderOnly: true, name: 'อุปกรณ์หมุน+จุดหมุน', price: 1, unit: 'ชุด', count: "Math.round(200*(W*100)/100) + Math.round(160*(Math.trunc((form==='นอน' ? (H*100) : (W*100))/(4.06+0.2))+1))" },
    ],
  ...
  roof: {
    ...
    consum: [
      ...
      { box: 'กล่อง|4', name: 'รางน้ำอลู', price: 'CF*2273', unit: 'เส้น', count: 'nGutter' },
      ...
      rm('ไวนิล', 'แผ่นไวนิล (7ม.)', "material==='ไวนิล'?Math.ceil(Math.ceil(Wc/25)/Math.max(1,Math.trunc(700/Dc))):0"),
      ...
      rm('ชินโคร์ Nature 6มม', 'ชินโคร์ Nature 6มม', "material==='ชินโคร์ Nature 6มม'?Math.ceil(Wc/138)*(1.38*E7):0"),
      rm('ชินโคร์ Shade 4มม', 'ชินโคร์ Shade 4มม', "material==='ชินโคร์ Shade 4มม'?Math.ceil(Wc/138)*(1.38*E7):0"),
      rm('ชินโคร์ Prime 10มม', 'ชินโคร์ Prime 10มม', "material==='ชินโคร์ Prime 10มม'?Math.ceil(Wc/138)*(1.38*E7):0"),
      rm('ชินโคร์ Grand 10มม', 'ชินโคร์ Grand 10มม', "material==='ชินโคร์ Grand 10มม'?Math.ceil(Wc/138)*(1.38*E7):0"),
  ...
  roof_gable: {
    ...
    consum: [
      ...
      rm('ไวนิล', 'แผ่นไวนิล (2 ด้าน)', "material==='ไวนิล'?2*Math.ceil(Math.ceil(Dc/25)/Math.max(1,Math.trunc(700/E2))):0"),
  ...
  ceil_gypsum: {
    ...
    consum: [
      { name: 'แผ่นยิปซัม 9มม. (1.2×2.4)', sku: 'JR03038', price: 284, unit: 'แผ่น', count: 'Math.ceil(area*1.1/2.88)' },
      { name: 'โครงซีไลน์ (ฟิวริ่ง)', sku: 'JR03043', price: 50, unit: 'เส้น', count: 'Math.ceil(area*2.5/4)' },
      { name: 'โครงเคร่าหลัก (อาบ)', sku: 'JR03041', price: 50, unit: 'เส้น', count: 'Math.ceil(area/4)' },
      { name: 'ขาแขวน', sku: 'JR03042', price: 50, unit: 'เส้น', count: 'Math.ceil(area*0.3/4)' },
      { name: 'สกรูยึดแผ่น', sku: 'JR03048', price: 0.5, unit: 'ตัว', count: 'Math.ceil(area*15-1e-9)' },
      { name: 'สกรูยึดโครง', sku: 'JR03045', price: 0.5, unit: 'ตัว', count: 'Math.ceil(area*5-1e-9)' },
      { name: 'ปูนฉาบรอยต่อ', sku: 'JR03046', price: 240, unit: 'ถุง', count: 'Math.ceil(area*0.5/50)' },
      { name: 'เทป/ตาข่าย', sku: 'JR03049', price: 70, unit: 'ม้วน', count: 'Math.ceil(area/60)' },
      { box: 'ฉาก|4หุน', name: 'ฉากโอบ อลู 4หุน (เส้น 6ม.)', price: 70, unit: 'เส้น', count: 'Math.ceil(PERIM/6)' },
      { name: 'ฉนวน rockwool 3"', sku: 'JR03047', price: 130, unit: 'แผ่น', count: "form==='ใส่ฉนวน rockwool 3\"'?Math.ceil(area/0.72):0" },
  ...
  wall_smartboard: {
    ...
    alu: [], glass: null, hardware: [],
    consum: [
      { name: 'แผ่นสมาร์ทบอร์ด 12มม. (2 หน้า)', sku: 'JR03044', price: 500, unit: 'แผ่น', count: 'Math.ceil(area*2*1.1/2.88)' },
      { name: 'โครงเหล็กกรอบ 1½×3" (รอบ)', sku: 'JR03053', price: 440, unit: 'เส้น', count: 'Math.ceil(PERIM/6)' },
      { name: 'ซีไลน์ 3" เสาตั้ง (ดิ่ง) @0.60', sku: 'JR03054', price: 62, unit: 'เส้น', count: 'Math.ceil((Math.ceil(W/0.6)-1)*H/3)' },
      { name: 'ซีไลน์ 3" ถักนอน (ราบ) @0.40', sku: 'JR03050', price: 62, unit: 'เส้น', count: 'Math.ceil((Math.ceil(H/0.4)-1)*W/3)' },
      { name: 'ฉนวน 3" (60×120)', sku: 'JR03051', price: 130, unit: 'แผ่น', count: "form==='ใส่ฉนวน 3\"'?Math.ceil(area/0.72):0" },
      { name: 'สกรูยึดแผ่น (2 หน้า)', sku: 'JR03052', price: 0.5, unit: 'ตัว', count: 'Math.ceil(area*30-1e-9)' },
      { name: 'สกรูยึดโครง', sku: 'JR03045', price: 0.5, unit: 'ตัว', count: 'Math.ceil(area*10-1e-9)' },
      { name: 'ปูนฉาบรอยต่อ (2 หน้า)', sku: 'JR03055', price: 240, unit: 'ถุง', count: 'Math.ceil(area*1/50)' },
      { name: 'เทป/ตาข่าย (2 หน้า)', sku: 'JR03062', price: 70, unit: 'ม้วน', count: 'Math.ceil(area/30)' },
  ...
  wall_isowall: {
    ...
    alu: [], glass: null, hardware: [],
    consum: [
      { name: 'แผ่นไอโซวอล 100มม. (≤2.4ม.)', sku: 'JR03059', price: 2016, unit: 'แผ่น', count: 'H<=2.4?Math.ceil(W/1.2)*Math.ceil(H/2.4):0' },
      { name: 'แผ่นไอโซวอล 100มม. (>2.4ม.)', sku: 'JR03060', price: 2520, unit: 'แผ่น', count: 'H>2.4?Math.ceil(W/1.2)*Math.ceil(H/3):0' },
      ...
      { name: 'สกรู/รีเวท + ยึด (เหมา)', sku: 'JR03058', price: 50, unit: 'งาน', count: '1' },
  ...
  wall_corrugated: {
    ...
    alu: [], glass: null, hardware: [],
    consum: [
      { name: 'แผ่นอลูลูกฟูก (ต้นทุน ≈ ขาย R3.9 3,500 ÷2)', sku: 'JR03061', price: 1750, unit: 'ตร.ม.', count: 'area' },
      { name: 'โครงเหล็กกรอบ 1½×3" (รอบ)', sku: 'JR03053', price: 440, unit: 'เส้น', count: 'Math.ceil(PERIM/6)' },
      { name: 'ซีไลน์ 3" เสาตั้ง (ดิ่ง) @0.60', sku: 'JR03054', price: 62, unit: 'เส้น', count: 'Math.ceil((Math.ceil(W/0.6)-1)*H/3)' },
      { name: 'ซีไลน์ 3" ถักนอน (ราบ) @0.40', sku: 'JR03050', price: 62, unit: 'เส้น', count: 'Math.ceil((Math.ceil(H/0.4)-1)*W/3)' },
      { name: 'สกรู/รีเวท ยึดแผ่น+โครง', sku: 'JR03064', price: 0.5, unit: 'ตัว', count: 'Math.ceil(area*20-1e-9)' },
      { labor: true, name: 'ค่าแรงผลิต', price: 700, unit: 'ตร.ม.', count: 'area' },
      { labor: true, name: 'ค่าแรงติดตั้ง', price: 400, unit: 'ตร.ม.', count: 'area' },
    ],
  ...
  wall_composite: {
    ...
    alu: [], glass: null, hardware: [],
    consum: [
      { name: 'แผ่นคอมโพสิต 3มม. (ต้นทุน ≈ ขาย R3.9 3,300 ÷2)', sku: 'JR03063', price: 1650, unit: 'ตร.ม.', count: "form==='คอมโพสิต 4มม.'?0:area" },
      { name: 'แผ่นคอมโพสิต 4มม. (ต้นทุน ≈ ขาย R3.9 4,000 ÷2)', sku: 'JR03065', price: 2000, unit: 'ตร.ม.', count: "form==='คอมโพสิต 4มม.'?area:0" },
      { name: 'โครงเหล็กกรอบ 1½×3" (รอบ)', sku: 'JR03053', price: 440, unit: 'เส้น', count: 'Math.ceil(PERIM/6)' },
      { name: 'ซีไลน์ 3" เสาตั้ง (ดิ่ง) @0.60', sku: 'JR03054', price: 62, unit: 'เส้น', count: 'Math.ceil((Math.ceil(W/0.6)-1)*H/3)' },
      { name: 'ซีไลน์ 3" ถักนอน (ราบ) @0.40', sku: 'JR03050', price: 62, unit: 'เส้น', count: 'Math.ceil((Math.ceil(H/0.4)-1)*W/3)' },
      { name: 'สกรู/รีเวท ยึดแผ่น+โครง', sku: 'JR03064', price: 0.5, unit: 'ตัว', count: 'Math.ceil(area*20-1e-9)' },
  ...
  ceil_wood: {
    ...
    consum: [
      ...
      { name: 'ขาจับฝ้า (ไม้ทิพย์)', sku: 'JR03066', price: 190, unit: 'เส้น', count: 'ROW.carrier? Math.ceil(area-1e-9) : 0' },
      { name: 'ฉากเก็บขอบรอบ', price: 'ROW.edge_p', unit: 'เส้น', count: 'ROW.edge_p>0? Math.ceil(PERIM/ROW.edge_len-1e-9) : 0' },
      { name: 'โครงซีไลน์ (มาตรฐาน @1.2)', sku: 'JR03069', price: 50, unit: 'เส้น', count: 'Math.ceil((area/1.2 + Math.ceil(area/1.44-1e-9)*0.3)/4 -1e-9)' },
  ...
  screen: {
    ...
    hardware: [],
    consum: [
      { name: 'เสา (เส้น 6ม.)', sku: 'JR03071', price: 625, unit: 'เส้น', count: 'Math.round(N*2*H/6*100)/100' },
      { name: 'ขวาง (เส้น 6ม.)', sku: 'JR03070', price: 625, unit: 'เส้น', count: 'Math.round(N*2*SW/6*100)/100' },
      { name: 'ยางอัด (ม.)', sku: 'JR03067', price: 5, unit: 'ม.', count: 'Math.round(N*2*(SW+H)*100)/100' },
      ...SCREEN_FABRIC_ROWS,
    ],
  ...
  screen_big: {
    ...
    consum: [
      ...
      { name: 'ขวาง 20051 (เส้น 6ม.)', sku: 'JR03076', price: 885, unit: 'เส้น', count: 'Math.round(N*2*SW/6*100)/100' },
      { name: 'ยางอัด (ม.)', sku: 'JR03067', price: 5, unit: 'ม.', count: 'Math.round(N*2*(SW+H)*100)/100' },
      ...SCREEN_FABRIC_ROWS,
      { name: 'ผ้าสแตนเลสนิรภัย 304', sku: 'JR03074', price: 650, unit: 'ตร.ม.', count: "material==='นิรภัยสแตน 304'?FABQ:0" },   // ⚠️ทุน 650/ตร.ม. · R3.9 ขายเป็น tier 3500/3200/3000 ตามพื้นที่ — รอพี่เคาะใน Excel ทุนรวม
    ],
  ...
  cabinet_face: {
    ...
    hardware: [
      ...
      { name: 'บานพับ (4ชิ้น/บาน)', sku: 'JR03073', price: 80, unit: 'ถุง', count: "form==='บานเปิด'?P:0" },
