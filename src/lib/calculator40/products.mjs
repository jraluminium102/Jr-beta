...
export const PRODUCTS = {
  ...
  pcdoor: {
    ...
    alu: [
      ...
      { name: 'กรอบบานเลื่อน sms (สูง)', needCode: true, price: 1995, kg: 11.328, seg: 'H-0.025-(SILL?0.103:0.058)', count: 'P' },
      { name: 'กรอบบานเลื่อน sms (กว้าง)', needCode: true, price: 1995, kg: 11.328, seg: "W/P-(form==='แบ่ง 4'?0.10:0.102)", count: 'P' },
  ...
  fold_euro: {
    ...
    consum: [
      ...
      { name: 'สักหลาด 5mm', needCode: true, price: 1.22, unit: 'ม.', count: 'Math.round(((H*1000-94)*2+(H*1000-80)*2)/1000*10)/10' },
