...
const GATE_BOX = { '1x1': 310, '1x1.5': 395, '1x1.6': 485, '1x4': 905, '1x5': 500, '1.6x1.6': 770, '1.6x4': 1220 };
const gateSlats = (side) => Object.entries(GATE_BOX).map(([m, price]) => {
  const [a, b] = m.split('x');
  const pick = side === 'A' ? "material==='" + m + "'" : "(spec.gboxB || material)==='" + m + "'";
  return {
    box: 'กล่อง|' + m.toUpperCase(),
    code: 'กล่อง ' + a + '"x' + b + '"',
    name: 'ใบระแนง ' + side + ' (กล่อง ' + a + '×' + b + '″)',
    price, kg: 0,
...
export const PRODUCTS = {
  ...
  gate: {
    ...
    materialLabels: { '1x1': '1×1″ · 310', '1x1.5': '1×1.5″ · 395', '1x1.6': '1×1.6″ · 485', '1x4': '1×4″ · 905', '1x5': '1×5″ · 500', '1.6x1.6': '1.6×1.6″ · 770', '1.6x4': '1.6×4″ · 1,220' },
    ...
    alu: [
      ...
      { box: 'ฉาก|2', code: 'ฉาก 2"', name: 'ฉากข้อ 2" (เฉพาะแปะนอก)', price: 320, kg: 0, seg: 'W', count: 'OUT' },
    ...
    hardware: [
      ...
      { name: 'ล้อวิ่ง 3"', price: 299, unit: 'ตัว', count: '2 + (W*100 > 400 ? Math.ceil((W*100-400)/100) : 0)' },
      { name: 'ล้อไกด์ประคองหลัง', price: 30, unit: 'ตัว', count: '4' },
    ...
    specOpts: [
      ...
      { key: 'gboxB', label: '[สลับ] กล่อง B', opts: ['1x1', '1x1.5', '1x1.6', '1x4', '1x5', '1.6x1.6', '1.6x4'], def: '1x1.6',
        labels: { '1x1': '1×1″', '1x1.5': '1×1.5″', '1x1.6': '1×1.6″', '1x4': '1×4″', '1x5': '1×5″', '1.6x1.6': '1.6×1.6″', '1.6x4': '1.6×4″' }, priced: true },
