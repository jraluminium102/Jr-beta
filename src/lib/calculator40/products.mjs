...
export const PRODUCTS = {
  ...
  gate: {
    ...
    // poolBars: กล่องเหล็กตัดรวมทั้งบาน เศษเส้นเอาไปตัดท่อนอื่นต่อได้ → นับเส้นแบบเดียวกับใบตัด
    defaults: { w: 350, h: 180, p: 1 }, defGlass: null, minP: 1, maxP: 1, stockLen: 6.0, poolBars: true,
    vars: {
      BOXP: "({'1x5':500,'1x1':310,'1x1.5':395,'1x1.6':485,'1x4':905,'1.6x1.6':770,'1.6x4':1220}[material]||1220)",
      GSTAND: 'H-0.155',   // เสาตั้ง = สูง−15.5 ซม. (ยัดใน) ตรง gStand ในไฟล์ตัดประกอบ
    ...
    // โครงกล่องยึดตามไฟล์ตัดประกอบ (GATE_SLIDE profiles) — เดิมเดาเป็น "เส้น" จากเส้นรอบรูป ทำให้ตัดเส้นขาด
    alu: [
      { box: 'กล่อง|2X4', code: 'กล่อง 2"x4"', name: 'เสาตั้งข้าง (กล่อง 2×4)', price: 1540, kg: 0, seg: 'GSTAND', count: '2' },
      ...
      { box: 'กล่อง|2X4', code: 'กล่อง 2"x4"', name: 'เสาตั้งท้ายหาง (2×4)', price: 1540, kg: 0, seg: 'GSTAND', count: '1' },
      { box: 'กล่อง|2X4', code: 'กล่อง 2"x4"', name: 'เส้นทแยงค้ำมุมบน (2×4)', price: 1540, kg: 0, seg: '0.391', count: '1' },
      { box: 'กล่อง|4X4', code: 'กล่อง 4"x4"', name: 'เสารับไกด์ (กล่อง 4×4) — เสาแยก', price: 2210, kg: 0, seg: 'H', count: '1' },
    ],
    glass: null,
    hardware: [
      { name: 'ใบระแนง (กล่องที่เลือก)', price: 'BOXP', unit: 'เส้น', count: 'E8', mult: true },
      { name: 'เหล็กยัดเสา 4"×4"', price: 860, unit: 'ชิ้น', count: '1' },
      // ล้อวิ่ง: ชื่อ+จำนวนตรงไฟล์ตัดประกอบ — กว้างเกิน 400 ซม. เพิ่มล้อทุก 100 ซม.
      { name: 'ล้อวิ่ง 3"', price: 299, unit: 'ลูก', count: '2 + (W*100 > 400 ? Math.ceil((W*100-400)/100) : 0)' },
