...
export const PRODUCTS = {
  ...
  euro_slide: {
    ...
    alu: [
      ...
      { name: 'คิ้ว ตั้ง', code: 'F7919', price: 200, kg: 1.08108, seg: 'H', count: '2*P' },
      { name: 'คิ้ว ขวาง', code: 'F7919', price: 200, kg: 1.08108, seg: 'W/P', count: '2*P' },
      ...
      { name: 'ตบปิดน๊อต F7988', code: 'F7988', price: 120, kg: 0.66667, seg: 6.4, count: '2*Math.max(P-1,0)' },
      ...
      { name: 'ชนกลาง(เปิดคู่กลาง)', code: 'F7855', price: 1230, kg: 6.64865, seg: 6.4, count: "form==='เปิดคู่กลาง'?1:0" },
