...
export const PRODUCTS = {
  ...
  handrail: {
    id: 'handrail', group: 2, name: 'ราวกันตก/ราวบันได กระจก', brand: '-', laborKey: 'ระแนง',
    showColor: true,   // กล่องสี 13 สี (อลูราวจับ/เสา · label-only)
    icon: '🛡️', sellR39: true, r39method: 'per_length_tier', r39min: 0, cascade: true,
    materialLabel: 'ทรง · ระบบยึด', cascadeLabels: ['ทรง', 'ระบบยึด'],
    addons: ['handrail_grip'],   // ราวจับด้านบน (ยู 5หุน +500/ม. · กล่อง 1"x2" +600/ม.)
    specOpts: [{ key: 'glassThick', label: 'ความหนากระจก', opts: ['เทมเปอร์ใส 10มม.', 'เทมเปอร์ใส 12มม.'], def: 'เทมเปอร์ใส 10มม.' }], // R3.9 label · พิมพ์ลงใบ (ราคาไม่ขึ้นกับความหนา)
    ...
    lut: {
      'เฉียง|หมุดแปะข้าง': { r39key: 'IMP1', name: 'หมุดแปะข้าง' },
      'เฉียง|ยูเหล็ก+ครอบอลู': { r39key: 'IMP2', name: 'ยูเหล็ก + ครอบอลู' },
      'เฉียง|เสาตั้ง+ราวจับอลู': { r39key: 'IMP3', name: 'เสาตั้ง + ราวจับอลู' },
      'ตรง|หมุดแปะข้าง': { r39key: 'IMP4', name: 'หมุดแปะข้าง' },
      'ตรง|ยูเหล็ก+ครอบอลู': { r39key: 'IMP5', name: 'ยูเหล็ก + ครอบอลู' },
      'ตรง|เสาตั้ง+ราวจับอลู': { r39key: 'IMP6', name: 'เสาตั้ง + ราวจับอลู' },
    },
    defMaterial: 'เฉียง|หมุดแปะข้าง',
    defForm: 'มาตรฐาน', forms: ['มาตรฐาน'],
    defaults: { w: 300, h: 110, p: 1 }, defGlass: null, minP: 1, maxP: 1,
    alu: [], glass: null, hardware: [], consum: [],
    note: 'กรอก "กว้าง(ซม.)" = ความยาวราว · ราคา R3.9 ต่อความยาว (เฉียง>ตรง · หมุดแปะข้างแพงสุด) รวมกระจก+ติดตั้ง · "สูง" ไม่กระทบราคา · ทุน R4.0 จริงรอ Excel',
  },
  ...
  bar_slide: {
    id: 'bar_slide', group: 2, subcat: 'ระแนง', name: 'ระแนงเลื่อน (ลูกฟูกเรียบ 2 ทาง · ข้อ 38.2)', brand: 'MTONG', laborKey: '-',
    showColor: true, outdoor: true, icon: '▤', sellDirect: true, sellRate: 'spec.barRate||0', sellInstallRate: '0',
    defForm: 'เลื่อน', forms: ['เลื่อน'],
    ...
    note: 'ระแนงเลื่อน (R3.9 ข้อ 38.2) — R3.9 ไม่มีสูตรทุน คิดราคามือ → กรอกราคา/ตร.ม. · รอ BOM มด',
  },
  bar_openclose: {
...
export const PRODUCTS_TODO = [
  ...
  { group: 6, name: 'ห้องกระจก (room builder)', note: 'ประกอบจาก ติดตาย+บานเปิด — ยังไม่ทำตัวประกอบหลายช่อง' },
