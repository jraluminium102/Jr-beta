...
export const PRODUCTS = {
  ...
  open_door: {
    ...
    hardware: [
      // ▸ ชุดประตู
      { name: 'บานพับ hyda HD-631', sku: 'JR00489', price: 85, unit: 'ตัว', count: 'WIN?0:HG*P' },
      { name: 'มือจับ ล็อค+กุญแจ (KINGBO)', sku: 'JR00315', price: 330, unit: 'ชุด', count: 'WIN?0:P' },
      { name: 'ตลับกุญแจไฮด้า', sku: 'JR00551', price: 0, unit: 'ตัว', count: 'WIN?0:1' },
      { name: 'ไส้กุญแจ CH 35x45', sku: 'JR00499', price: 400, unit: 'ตัว', count: 'WIN?0:1' },
      { name: 'แผ่นรับล็อค', sku: 'JR00562', price: 0, unit: 'ชุด', count: 'WIN?0:1' },
      { name: 'CDQ (บานลอง)', sku: 'JR00596', price: 0, unit: 'ตัว', count: 'WIN?0:Math.max(P-1,0)' },
      { name: 'ปลายกลอน (บานลอง)', sku: 'JR00598', price: 0, unit: 'ตัว', count: 'WIN?0:Math.max(P-1,0)' },
