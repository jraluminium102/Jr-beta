...
export const PRODUCTS = {
  ...
  euro_slide: {
    ...
    alu: [
      ...
      // รอยต่อบานละ 2 ท่อน (2*F6) — สูงเกิน 2.6 ม. แบ่งครึ่งเป็นเสารับแรง (เจ้าของ: "ใช้ผสมกัน")
      //   600×300 3 บาน = ตบเกี่ยว 2 + เสารับแรง 2 · ไม่เกิน 2.6 ม. = ตบเกี่ยว 4 ล้วน
      { name: 'ตบเกี่ยว', code: 'F7983', price: 465, kg: 2.51351, seg: 'H', count: 'H>2.6?F6:2*F6' },
      ...
      { name: 'เสารับแรง (สูงเกิน 2.6 ม.)', code: 'F7951', price: 2020, kg: 10.91892, seg: 'H', count: 'H>2.6?F6:0' },
