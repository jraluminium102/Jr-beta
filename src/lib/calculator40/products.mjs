...
export const PRODUCTS = {
  ...
  euro_slide: {
    ...
    alu: [
      ...
      { name: 'ตบยูข้าง (F7988)', code: 'F7988', price: 120, kg: 0.66667, seg: 6.4, count: '2*Math.max(P-1,0)' },
      { name: 'ปิดตบเกี่ยว (F7988)', code: 'F7988', price: 120, kg: 0.66667, seg: 6.4, count: "LOWRAIL?4:(form==='เปิดคู่กลาง'?2:(P-1))" },
      { name: 'ตบกันสาด#2 (F7988)', code: 'F7988', price: 120, kg: 0.66667, seg: 6.4, count: 'LOWRAIL?0:1' },
      { name: 'ปิดรับล็อค (F7988)', code: 'F7988', price: 120, kg: 0.66667, seg: 6.4, count: "form==='เปิดคู่กลาง'?1:0" },
