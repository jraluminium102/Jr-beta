...
export const PRODUCTS = {
  ...
  euro_slide: {
    ...
    alu: [
      ...
      { name: 'ตบปิดเฟรมร่องใน', code: 'F7880', price: 345, kg: 1.86486, seg: 'W', count: "form==='เปิดคู่กลาง'?2:0" },
      { name: 'ตบปิดเฟรมร่องกลาง', code: 'F7879', price: 355, kg: 1.91892, seg: 'W', count: "form==='เปิดคู่กลาง'?2:0" },
    ],
    glass: '((W)+(P-1)*0.1)*H',
  ...
  velora: {
    ...
    alu: [
      ...
      // ⚠ Velora นับ "เส้นเต็ม" ตามชีตถอดทุน (ROUNDUP ต่อใบ · 2ใบ ใช้วงกบร่วม + เสากลาง)
      //   ใบตัดนับเป็น "ท่อน" ต่อบาน (1 บาน = 1 ชุดวงกบ) → 2 บานขึ้นไปจึงนับคนละวิธี
      //   ลองแยกท่อนแล้วทุนเด้ง +19% (5,919 → 7,045) เพราะเส้นเดียวตัดหลายท่อนร่วมกันไม่ได้
      //   → คงวิธีนับตามถอดทุนไว้ก่อน รอเจ้าของเคาะว่า 2 บานใช้วงกบร่วมหรือแยก
