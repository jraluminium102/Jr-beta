...
const NO_CODE_PRICE: { match: RegExp; price: number; unit: string; as?: string }[] = [
  ...
  //   ไฟล์ไม่ระบุวัสดุ → ใช้ราคาเดียวกับรางน้ำอลูของหลังคา (2,273/เส้น ชีตถอดทุน v9) รอเจ้าของยืนยัน
  { match: /^ราง \(เท่ากว้าง\)/, price: 2273, unit: "เส้น", as: "ราง ขอบต่ำ (ยาวเท่าความกว้าง)" },
];
