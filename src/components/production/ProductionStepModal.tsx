...
const TRANSITIONS: Record<ProdStatus, Action[]> = {
  ...
  QUEUED: [
    { to: "MANUFACTURING", label: "เริ่มผลิต", hint: "ใส่วันติดตั้ง/กำหนดเสร็จได้ (ไม่บังคับ · กรอกทีหลังได้)", tone: "go" },
  ],
...
export function ProductionStepModal({
  ...
  const clickAction = (a: Action) => {
    // เริ่มผลิต (จากรอลงผลิต) — free-space: กดได้เลย ไม่บังคับวันติดตั้ง/กำหนดเสร็จ (กรอกทีหลังได้ · คนจัดการเอง)
