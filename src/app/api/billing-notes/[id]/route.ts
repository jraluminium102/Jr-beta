...
export const PATCH = withRoute(
  async (req: Request, { params }: { params: { id: string } }) => {
    ...
    // 0133 — แก้ได้แม้ชำระ/มีใบเสร็จ · เก็บไว้เตือนบนหน้าจอแทนการบล็อก
    ...
    if (rev) {
      ...
      // ชำระแล้ว — ไม่บล็อกแล้ว (เจ้าของสั่ง 1 ก.ย.69 · 0133 "ห้ามฟิก")
      ...
      if (instIds.length > 0) {
        ...
        // มีใบเสร็จ/รายการเงินผูกอยู่ — แก้ได้ แต่ติดธงไว้ให้หน้าจอเตือนว่าต้องไล่เช็คเอกสารตาม (0133)
