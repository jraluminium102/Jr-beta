...
export default async function BillingNoteDetail({ params }: { params: { id: string } }) {
  ...
  if (bn.quotation_id) {
    // + revision_no สำหรับป้าย "อ้าง Rev เก่า" (0133) — เผื่อ 0093 ยังไม่รัน → ถอยไป select แบบเดิม
  ...
  // ป้ายเตือน "ใบนี้อ้าง Rev เก่า" (0133) — เตือนอย่างเดียว ไม่ล็อกอะไรทั้งสิ้น
