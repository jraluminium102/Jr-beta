...
| **A4** | 🟠 P1 | create quote: ลูกค้าจากเครื่องคิดราคามาแค่ชื่อ string ไม่มี `customer_id` → เลือก dropdown ซ้ำ | `QuotationForm.tsx` | UX สะดุด, เสี่ยงเลือกผิดคน | ✅ **แก้แล้ว** — fuzzy-match → preselect + hint ✓/⚠️ |
