#!/usr/bin/env node
/**
 * audit-r41 — เทียบ "คิดราคา 4.0 บนเว็บ" กับชุดข้อมูล ส่งต่อ-เว็บ/tests.json
 *   ⚠ เลิกใช้ตัดสินราคาขาย (10 ก.ย.69): tests.json = export รุ่นเก่า ขนาด/ทุนไม่ใช่ชุดเดียวกับ PDF R4.1
 *     ใช้ scripts/audit-r41-pdf.mjs แทน (อ่านทุกแถวจาก PDF จริง)
