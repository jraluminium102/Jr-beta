...
const T = [
  ...
  // 21 ก.ย.69: เคสนี้เดิมตรึง "2026-09-06" ไว้ พอเลยวันนั้นมาแล้วมันคือ "อดีต" → ผ่านถูกแล้ว
  //   เจตนาจริงคือ "วัน/เดือนสลับแล้วกลายเป็นอนาคต" → ใช้วันพรุ่งนี้แทน จะได้ไม่หมดอายุอีก
  [TOMORROW, false, false, "เคสจริง คุณสายทิพย์ (วันพรุ่งนี้ = อนาคต)"],
