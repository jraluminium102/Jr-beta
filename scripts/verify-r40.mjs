...
const ANCHORS = [
  ...
  { id: 'folding', in: { w: 180, h: 280, p: 2, form: '2บาน: รวบเปิดซ้าย (2-0)' }, cost: 17453.26, labor: 'baseXpanel' },   // −280: แยกท่อน+หักลบตามใบตัด HOMELIFE (เจ้าของสั่ง 21 ส.ค.69 ยึดใบตัด)   // calibrate HW ตรง matrix มด
