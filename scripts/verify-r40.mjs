...
const ANCHORS = [
  ...
  { id: 'fold_euro', in: { w: 180, h: 280, p: 2, form: '2บาน: 2-0 พับข้างเดียว' }, cost: 19073.06, labor: 'baseOnly' }   /* 3 ก.ย.69 −13.30 = ถอดสักหลาด (เจ้าของสั่ง "ไม่มี") */,   // +815.70 (24 ส.ค.69): แยกเส้นรายท่อนตามใบตัด + อุปกรณ์ HD ผูกราคาสโตร์
