...
const ANCHORS = [
  ...
  { id: 'open_door', in: { w: 150, h: 200, p: 1, form: 'มีธรณี' }, cost: 7829.73 },   // รื้อตามไฟล์ตัดประกอบ + ใส่ราคาอุปกรณ์ตามชีตถอดทุน v9 (ค่าอุปกรณ์ = 1,638 ตรงไฟล์เป๊ะ)
...
const ANCHORS150 = [
  ...
  { id: 'open_door', in: { p: 2, form: 'มีธรณี' }, cost: 9586.70 },   // เหตุผลเดียวกับ anchor 150×200
...
const ANCHORS_COLOR = [
  ...
  ['open_door', { w: 150, h: 150, p: 2, form: 'มีธรณี' }, { white: 9586.70, sahara: 12083.93, woodStock: 13185.13 }],
];
