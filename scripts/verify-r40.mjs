...
const ANCHORS_COLOR = [
  ...
  ['open_door', { w: 150, h: 150, p: 2, form: 'มีธรณี' }, { white: 9624.99, sahara: 10750.35, woodStock: 13177.78 }],   // sahara ลด: ธรณีใช้ราคาสีสำเร็จจากไฟล์ (1635) แทน ขาว+ค่าอบ
];
