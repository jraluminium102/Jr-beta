...
const ANCHORS150 = [
  ...
  { id: 'velora', in: { p: 2, form: 'เดี่ยว', color: 'white' }, cost: 9045.15 },   // +2,000 ค่าเปิดตู้อบ (10 ก.ย.69) — ซื้อเส้นมาสีมิว สีอบขาว/ดำ ก็ต้องเข้าตู้ (prod.millBar)   // ใบตัด: 1 บาน = 1 ชุดวงกบ (ไม่ใช้วงกบร่วม) — เจ้าของสั่งยึดใบตัด 21 ส.ค.69      // สีขาว = ต้องมีค่าอบเรตเทา (rawAlu)
