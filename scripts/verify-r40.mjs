...
const LABOR_SRC = {
  ...
  // บานยก — ยึดไฟล์ใหม่ "ถอดทุน_รวมทั้งหมด v20.xlsx" ชีต ค่าแรง แถว 24 (เจ้าของส่ง 31 ส.ค.69 · เฉพาะบานยก)
  //   เดิม (v9): 16ชม./0.3333/1คน · 7ชม./0.3333/1คน → v20: คนผลิต 1.5 · ติดตั้ง 3.5 คน ชม.ฐานติดตั้ง 3.5
...
const ANCHORS = [
  ...
  { id: 'euro_slide', in: { w: 600, h: 300, p: 3, form: 'อิสระ' }, cost: 32636.23 },   // +134 จากชีต: เจ้าของเคาะ 21 ส.ค.69 (ฉากประกอบมุม 8→12/บาน · ยาง+วาวรูน้ำ อันละ ฿5)
  ...
  { id: 'awning', in: { w: 40, h: 40, p: 1, form: 'อิสระ' }, cost: 2463.41 },
  ...
  { id: 'gate', in: { w: 350, h: 180, p: 1, form: 'นอน', material: '1.6x4' }, cost: 49768, costOnly: true },
  ...
  { id: 'roof', in: { w: 400, h: 200, p: 1, form: 'หลังคาเพิง' }, cost: 26659 },
  ...
  { id: 'pcdoor', in: { w: 150, h: 200, p: 2, form: 'แบ่ง 2' }, cost: 11090.12 },   // 24 ส.ค.69 ยึดใบตัด: +คาน 1"×4 +ชนกลาง B20046 (ของจริงที่ไม่เคยคิดเงิน) · กรอบ/คิ้ว แตกรายท่อนตามกระดานคำนวณ (หักเผื่อประกอบจริง → สั้นกว่าสูตรรวม 2PH+2W เดิมเล็กน้อย)
  ...
  { id: 'roof_gable', in: { w: 400, h: 200, p: 1, form: 'หลังคาจั่ว' }, cost: 41137 },
  ...
  { id: 'roof_slide', in: { w: 400, h: 200, p: 2, form: 'เลื่อนยื่น', addons: { slide_motor: { kw: '80' } } }, cost: 56922, costOnly: true },   // 50,722 + มอเตอร์ 80 กก. 6,200 (ราคา 4,500 + ค่าส่ง 1,700 ตรงชีต D13)
...
const ANCHORS150 = [
  ...
  { id: 'euro_slide', in: { p: 2, form: 'อิสระ' }, cost: 8167.93 },   // +36 จากชีต (ฉาก 12/บาน + ยาง/วาวรูน้ำ ฿5) — เจ้าของเคาะ 21 ส.ค.69
  ...
  { id: 'pcdoor', in: { p: 1, form: 'แบ่ง 2', spec: { pcsill: 'มีธรณี', pcsoft: 'ใส่' } }, cost: 7958.75 },   // 24 ส.ค.69: +คาน +ชนกลาง B20046 · กรอบ/คิ้วแตกรายท่อนตามใบตัด
  { id: 'awning', in: { p: 1, form: 'อิสระ' }, cost: 5669.39 },
...
console.log('▶ ประตูรั้ว — ระยะ@ ระแนง (350×180 นอน):');
{
  ...
  check('UI default spec = golden 49768', G({ rnFace: '4.06', rnGap: '5', drive: 'มอเตอร์อัตโนมัติ', gaterail: 'รางใหม่' }), 49768, 1);
  check('ระยะ@15 (ห่างขึ้น→ใบน้อยลง→ถูกลง)', G({ rnGap: '15' }), 37568, 1);
  check('ระยะ@2 (ถี่ขึ้น→ใบเยอะ→แพงขึ้น)', G({ rnGap: '2' }), 60748, 1);
}
...
const ANCHORS_COLOR = [
  ...
  ['euro_slide', { w: 150, h: 150, p: 2, form: 'อิสระ' }, { white: 8167.93, sahara: 8599.34, woodStock: 10853.57 }],   // +36 ทุกสี (ของที่เพิ่ม ไม่ขึ้นกับสี)
...
console.log('\n═══ ②g ราคาเส้นแยกสีจริง 6 สี (ไฟล์ v9 ชีตราคาสี) ═══');
{
  ...
  check('SMS ลายไม้สักทอง', teak, 57900, 1);
  check('SMS มะฮอกกานี', maho, 67200, 1);
  check('SMS เทาซาฮาร่า', sell('sahara', 'sahara'), 45300, 1);
  check('SMS สีขาว', sell('white', 'white'), 43200, 1);
