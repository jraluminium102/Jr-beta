...
const ANCHORS = [
  ...
  { id: 'euro_slide', in: { w: 600, h: 300, p: 3, form: 'อิสระ' }, cost: 30848.35 },
...
const ANCHORS150 = [
  ...
  { id: 'euro_slide', in: { p: 2, form: 'อิสระ' }, cost: 9606.88 },   // เวฟ 7: ความยาวตัดจริงตามแผง ⑦ (เดิม 9,806.53)   // เวฟ 3: มือจับเมโทร + ตบกันสาด 2 เส้น + มุมเลื่อน 8/บาน (เดิม 8,491.93)
...
const ANCHORS_COLOR = [
  ...
  ['euro_slide', { w: 150, h: 150, p: 2, form: 'อิสระ' }, { white: 9606.88, sahara: 10541.72, woodStock: 12915.36 }],   // เวฟ 3: มือจับเมโทร + ตบกันสาด 2 เส้น
...
console.log('\n═══ ②g ราคาเส้นแยกสีจริง 6 สี (ไฟล์ v20.1 ชีตราคาสี) ═══');
{
  ...
  //     → กองค่าอบหนักขึ้น ค่าตรึงขยับตาม (สีขาวไม่มีค่าอบ จึงเท่าเดิม 14,800.93)
  {
    ...
    check('ระแนงเลื่อน สีอบพิเศษ: ทุนรวม 23,986.42', Math.round(sp.cost.total * 100) / 100, 23986.42, 1);
    check('ระแนงเลื่อน ลายไม้อบพิเศษ: ทุนรวม 24,692.53', Math.round(wsp.cost.total * 100) / 100, 24692.53, 1);
