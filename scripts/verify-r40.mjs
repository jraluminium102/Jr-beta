...
const ANCHORS = [
  ...
  { id: 'open_door', in: { w: 150, h: 200, p: 1, form: 'มีธรณี' }, cost: 7354.73 },   // รื้อตามไฟล์ตัดประกอบ 21 ส.ค.69 (แยกท่อน+หักลบ · อุปกรณ์ชุดจริงมีรหัสสโตร์) — ยังขยับอีกเมื่อ JR00551/JR00562/JR00482/JR00557 มีราคา
  ...
  { id: 'pcdoor', in: { w: 150, h: 200, p: 2, form: 'แบ่ง 2' }, cost: 10900.76 },
...
const ANCHORS150 = [
  ...
  { id: 'open_door', in: { p: 2, form: 'มีธรณี' }, cost: 8565.70 },   // เหตุผลเดียวกับ anchor 150×200
  { id: 'pcdoor', in: { p: 1, form: 'แบ่ง 2', spec: { pcsill: 'มีธรณี', pcsoft: 'ใส่' } }, cost: 7627.11 },
...
const ANCHORS_COLOR = [
  ...
  ['open_door', { w: 150, h: 150, p: 2, form: 'มีธรณี' }, { white: 8565.70, sahara: 11062.93, woodStock: 12164.13 }],
];
