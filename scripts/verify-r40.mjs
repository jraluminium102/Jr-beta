...
const ANCHORS = [
  ...
  { id: 'folding', in: { w: 180, h: 280, p: 2, form: '2บาน: รวบเปิดซ้าย (2-0)' }, cost: 18311.41, labor: 'baseXpanel' },   // +1,257 (24 ส.ค.69): เสา/เสากุญแจ/เสากุญแจมือจับ/บังใบ นับจากตาราง config ในใบตัด (SMS240_CFG) แทนที่จะเดา 2×บาน — ของเดิมนับเสาขาด
