...
const ANCHORS = [
  ...
  { id: 'pcdoor', in: { w: 150, h: 200, p: 2, form: 'แบ่ง 2' }, cost: 11425.31 },   // +524.55 (24 ส.ค.69): ใบตัดมี "คาน (กล่อง 1\"×4\")" + "ชนกลางบานเลื่อน B20046" แต่คิดราคาไม่เคยคิดเงิน 2 ตัวนี้
...
const ANCHORS150 = [
  ...
  { id: 'pcdoor', in: { p: 1, form: 'แบ่ง 2', spec: { pcsill: 'มีธรณี', pcsoft: 'ใส่' } }, cost: 8126.34 },   // +499.23 = คาน + ชนกลาง B20046 (ตามใบตัด)
