...
console.log("═══ ⑫ ไม่มีรหัสที่สร้างเองหลงเหลือในสูตร (เจ้าของสั่ง 1 ก.ย.69) ═══");
{
  ...
  check("บรรทัดที่รอเจ้าของเติมรหัส (needCode)", need, 71, 0);   // 74 → 71 (3 ก.ย.69): PC Door เสาตั้ง B20051 + เสานอน B20054 ได้รหัสแล้ว · เฟี้ยมยูโรถอดสักหลาด   // 79 → 74: บานกระทุ้งตัด 5 รายการตามใบตัด (เจ้าของเคาะ 1 ก.ย.69)
