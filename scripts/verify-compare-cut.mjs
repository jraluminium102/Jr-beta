...
console.log("\n═══ ③ จับ 'ไม่ตรงกัน' ได้จริง (ไม่ใช่ขึ้นเขียวหมดทุกกรณี) ═══");
{
  ...
  ok("รายชื่อรุ่นที่เทียบได้ ตรงกับที่ from-recipe รองรับ", COMPARABLE.length === 17, String(COMPARABLE.length));   // +roof (26 ส.ค.69) · +roof_gable + หลังคาหลายด้าน 3 ทรง (27 ส.ค.69) · +กลาสเฮ้าส์เพิงตรง (28 ส.ค.69) · +บานยก (31 ส.ค.69)
