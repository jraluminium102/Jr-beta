...
const CASES = [
  ...
  { sheet: "คิดทุน ยูโร", id: "euro_slide", form: "อิสระ", alias: {
      ...
      // F7988 ทำ 3 หน้าที่ · ไฟล์รวมไว้แถวเดียว ("ตบปิดน๊อต") — เว็บแตกตามใบตัด ยูโร_ตัด #19/#20/#24
      "ตบยูข้าง": "ตบปิดน๊อต", "ปิดตบเกี่ยว": "ตบปิดน๊อต", "ปิดรับล็อค": "ตบปิดน๊อต",
  ...
  { sheet: "คิดทุน PC Door", id: "pcdoor", form: "แบ่ง 2",
    // จุดที่ "ตั้งใจ" ต่างจากชีต (24 ส.ค.69 เจ้าของสั่ง "ยึดใบตัด"): กรอบ/คิ้ว แยกรายท่อนตามกระดานคำนวณในไฟล์ใบตัด
    //   ชีตคิดทุนยังเขียนรวมก้อนเดียว (2PH+2W) → ชื่อบรรทัดไม่ตรงกัน เทียบจำนวนเส้นตรง ๆ ไม่ได้ (ยาวรวมต่างกันเล็กน้อยเพราะหักเผื่อประกอบจริง)
    known: {
      "กรอบประตู F7864": "แตกเป็น เมืองทอง สูง/กว้าง + เลื่อน sms สูง/กว้าง ตามใบตัด",
      "คิ้ว F7935": "แตกเป็นคิ้วรายท่อนวิ่งตามกรอบ ตามใบตัด",
    } },
];
