...
// addon door R3-1: +5,000/บานเพิ่ม (panels-1) → 2 บาน = +5,000 → core = base + 5,000 = 29,500
// floor (panels>1): per=monoRate(3.52/2=1.76,OPEN) → 1.76<2.0 rate=7500 → 1.76×7500=13,200 ; floor=13200×(1+0.67)=22,044
// core = max(29500, 22044) = 29,500 → roundUp 30,000 (R3-1: เดิม +14,000 เหมา = 39,000)
const it4 = makeItem({ prod: "casement_euro", group: 1, type: "door", width: "1.6", height: "2.2", panels: 2 });
tc("TC4", "บานเปิดคู่ 1.6×2.2", it4, 30000, "R3-1: base 24,500 + บานเพิ่ม 1×5,000 = 29,500 → roundUp 30,000");
