...
// ---------- TC3: ประตูบานเปิดยูโร เดี่ยว 1.0×2.2 (ต่อบาน) ----------
// casement-euro-price Linear: 15,000 + max(0, 2.2-1.2)×4,166.67 = 19,166.67 → roundUp 20,000
const it3 = makeItem({ prod: "casement_euro", group: 1, type: "door", width: "1.0", height: "2.2", panels: 1 });
tc("TC3", "บานเปิดยูโรเดี่ยว 1.0×2.2", it3, 20000, "Linear: 15,000+(2.2-1.2)×4,166.67=19,167 → roundUp 20,000");

// ---------- TC4: ประตูบานเปิดยูโรคู่ — ขนาด/บาน 0.8×2.2 × 2 บาน ----------
// Linear ต่อบาน: a=1.76 → 15,000+max(0,1.76-1.2)×4,166.67 = 17,333.33/บาน × 2 = 34,666.67 → roundUp 35,000
const it4 = makeItem({ prod: "casement_euro", group: 1, type: "door", width: "0.8", height: "2.2", panels: 2 });
tc("TC4", "บานเปิดยูโรคู่ 0.8×2.2/บาน ×2", it4, 35000, "Linear: (15,000+0.56×4,166.67)×2=34,667 → roundUp 35,000");
