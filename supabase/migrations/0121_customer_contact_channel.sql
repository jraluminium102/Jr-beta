-- 0121: ช่องทางติดต่อลูกค้า (LINE/FB/IG) เก็บที่ทะเบียนลูกค้า + ขึ้นเอกสารให้ถูกช่อง
--
...
comment on column public.customers.contact_channel is
  'ช่องทางติดต่อ: LINE | FB | IG | OTHER (0121) — คู่กับ line_id ที่เก็บชื่อ/handle · หัวเอกสารพิมพ์ตามช่องนี้';
